...
module Vizcore
  ...
  class Config
    ...
    attr_reader :host, :port, :scene_file, :audio_source, :audio_file, :audio_device, :noise_gate
    ...
    def initialize(scene_file:, host: DEFAULT_HOST, port: DEFAULT_PORT, audio_source: DEFAULT_AUDIO_SOURCE, audio_file: nil, audio_device: nil, noise_gate: DEFAULT_NOISE_GATE)
