...
The browser HUD also includes an Audio Inspector with amplitude, sub/low/mid/high meters, FFT preview bars, shader compile error overlay, emergency Blackout/Freeze controls, and Visual Gain, Bass Boost, Smoothing, Beat Hold, and Wobble controls for adapting visual response to different tracks and input levels.
